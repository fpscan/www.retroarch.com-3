    ...
    <head>
        ...
        <script>
          ...
          function showNSPConfirmation() {
            return confirm("USE OF THIS FILE IS DONE AT YOUR SOLE RISK AND IS WITHOUT WARRANTIES OF ANY KIND BY US, EXPRESSED, IMPLIED OR OTHERWISE INCLUDING WARRANTIES OF TITLE, FITNESS FOR PURPOSE, MERCHANTABILITY OR NON-INFRINGEMENT. UNDER NO CIRCUMSTANCES ARE WE LIABLE FOR ANY DAMAGES ARISING FROM THE USAGE OF THIS FILE ON YOUR NINTENDO SWITCH. WHEN USING THIS, YOU NEED TO BE PREPARED THAT A REAL RISK EXISTS THAT YOU MIGHT BE BANNED.");
          }
        </script>
    </head>
    <body>
